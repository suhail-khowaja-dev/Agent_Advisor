        ...
        <div class="tableContainer">
            ...
            <div class="tablee agentClientTable myagentClientTable">
                <div class="row">
                    ...
                    <div class="col-lg-9">
                        <p>{{ $details->getstate->state ?? ''}},{{ $details->getcity->city ?? ''}}</p>
                    </div>
            ...
            <div class="myStatus">
                ...
                <div class="statusOneB d-flex justify-content-between">
                    <div class="statusName d-flex align-items-center ">
                        ...
                        <div class="statusDropDown mystatusDropdown">
                            @if(($details->get_notes[0]->contact_established ?? '') == NULL)
                            <input type="text"   placeholder="not started" readonly>
                            @elseif(($details->get_notes[0]->contact_established ?? '') == 1)
                            <input type="text"   placeholder="not started" readonly>
                ...
                <div class="statusOneB d-flex justify-content-between">
                    <div class="statusName d-flex align-items-center ">
                        ...
                        <div class="statusDropDown mystatusDropdown">
                            @if(($details->get_notes[0]->meeting ?? '') == NULL)
                            <input type="text"  placeholder="not started" readonly>
                            @elseif(($details->get_notes[0]->meeting ?? '') == 1)
                            <input type="text"  placeholder="not started" readonly>
                ...
                <div class="statusOneB d-flex justify-content-between flex-column ">
                    <div class="mystatusOneB  d-flex justify-content-between align-items-center"
                        ...
                        <div class="statusName d-flex align-items-center ">
                            ...
                            <div class="statusDropDown mystatusDropdown">
                            @if(($details->get_notes[0]->contract ?? '') == NULL)
                            <input type="text"  placeholder="not started" readonly>
                            @elseif(($details->get_notes[0]->contract ?? '') == 1)
                            <input type="text"  placeholder="not started" readonly>
                    ...
                    <div class="agentAdress d-flex">
                        <div class="adresB">
                            ...
                            <input type="text" value="{{$details->get_notes[0]->address ?? ''}}" placeholder="" readonly>
                        </div>
                        <div class="adresB">
                            <label for="">
                                Sale price
                            </label>
                            <input type="text" value="${{$details->get_notes[0]->sale_price ?? ''}}" placeholder="$50555" readonly>
                        </div>
                    </div>
                </div>
                <div class="statusOneB d-flex justify-content-between flex-column ">
                    <div class=" mystatusOneB d-flex justify-content-between align-items-center"
                        ...
                        <div class="statusName d-flex align-items-center ">
                            ...
                            <div class="statusDropDown mystatusDropdown">
                            @if(($details->get_notes[0]->closed ?? '') == NULL)
                            <input type="text"  placeholder="not started" readonly>
                            @elseif(($details->get_notes[0]->closed ?? '') == 1)
                            <input type="text"  placeholder="not started" readonly>
