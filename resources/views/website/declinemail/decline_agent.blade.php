    ...
    <table
        ...
        <tr>
            ...
            color:#fff;padding-top: 0px;">
                    Hello !<br>{{$data->get_agent['name'] ?? ''}} has Declined Job Request !</h1>
            </th>
        </tr>
        {{-- <tr>
        ...
        <tr>
            <th>
                <p style=" font-family: Poppins-SemiBold;color: #fff;padding-top: 40px;">Agent {{$data->get_agent['name'] ?? ''}} has Declined Job Request.
                </p>
            </th>
        </tr>
    </table>
