    ...
    <table
        ...
        <tr>
            ...
            color:#fff;padding-top: 0px;">
                    Hello !<br>{{ $data->get_agent['name'] ?? '' }} has Accepted Job Request !</h1>
            </th>
        </tr>
        <tr>

            <th style="padding-top: 20px;"><img src="{{ $message->embed(asset('frontend/images/1x/thumbs-u.png')) }}"
        ...
        ">
                ...
                <p style="text-decoration:none;">Price:${{ $data['price'] }}</p>
        ...
        <tr>
            <th>
                <p style=" font-family: Poppins-SemiBold;color: #fff;padding-top: 40px;">Agent
                    {{ $data->get_agent['name'] ?? '' }} has Accepted Job Request.
                </p>
            </th>
        </tr>
    </table>
