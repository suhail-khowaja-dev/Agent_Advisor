                    ...
                    {{-- <div class="row">
                        <div class="col">
                            <div class="mb-3">
                                ...
                                <input name="email_two" class="form-control btn-square" id="exampleFormControlInput10" type="email" placeholder="email two">
                                @error('email_two')
                                    <p class="help-block" style="color: red">
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="mb-3">
                                ...
                                <input name="email_three" class="form-control btn-square" id="exampleFormControlInput10" type="email" placeholder="email three">
                                @error('email_three')
                                    <p class="help-block" style="color: red">
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="mb-3">
                                ...
                                <input name="contact" class="form-control btn-square" id="exampleFormControlInput10" type="number" placeholder="contact">
                                @error('contact')
                                    <p class="help-block" style="color: red">
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="mb-3">
                                ...
                                <input name="copyright" class="form-control btn-square" id="exampleFormControlInput10" type="text" placeholder="copyright">
                                @error('copyright')
                                    <p class="help-block" style="color: red">
