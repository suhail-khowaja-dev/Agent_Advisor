    ...
    <div class="col-sm-12">
        <div class="card">
            ...
            {{-- <form class="form theme-form"> --}}
                <form class="form theme-form"id="" action="{{ route("project_update",$edit_data->id) }}" enctype="multipart/form-data" method="post">
                    @csrf
                <div class="card-body">
                    <div class="row">
                        <div class="col">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                         ...
                         <img src="{{ asset('storage/uploads/cms/' . $edit_data->image) }}" alt="image" style="width:80px; height:80px;">
                        @else
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="mb-3 mb-0">
                                ...
                                <textarea value="" name="content" class="form-control btn-square" id="exampleFormControlTextarea14" rows="3">{{ $edit_data->content }}</textarea>
                            </div>
                        </div>
                    </div>
