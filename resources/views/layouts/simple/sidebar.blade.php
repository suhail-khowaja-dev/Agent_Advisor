				...
				<ul class="sidebar-links" id="simple-bar">
					...
					<li class="sidebar-list">
						...
						<ul class="sidebar-submenu" style="display: {{ request()->route()->getPrefix() == '/project'  ? 'block;' : 'none;' }}">
                            <li><a href="{{route('content')}}" class="{{ Route::currentRouteName()=='content' ? 'active' : '' }}" >{{ trans('Page Content') }}</a></li>
                            <li ><a href="{{route('note')}}" class="{{ Route::currentRouteName()=='note' ? 'active' : '' }}">{{ trans('Page Note') }}</a></li>
                    ...
                    <li class="sidebar-list">
                        <a class="sidebar-link sidebar-title {{request()->route()->getPrefix() == '/category_management' ? 'active' : '' }}" href="#">
                            <i data-feather="users"></i><span> {{ trans('category Management') }} </span>
                            <div class="according-menu"><i class="fa fa-angle-{{request()->route()->getPrefix() == '/category_management' ? 'down' : 'right' }}"></i></div>
                        </a>

                        <ul class="sidebar-submenu" style="display: {{ request()->route()->getPrefix() == '/category-management' ? 'block;' : 'none;' }}">
                            <li><a href="{{route('category-management')}}" class="{{ Route::currentRouteName()=='category-management' ? 'active' : '' }}">{{ trans('Category List') }}</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="sidebar-list">
						<a class="sidebar-link sidebar-title {{request()->route()->getPrefix() == '/Inquiry' ? 'active' : '' }}" href="#"><i data-feather="phone-forwarded"></i><span>{{ trans('Advisor Inquiry') }}</span>
						...
						<ul class="sidebar-submenu" style="display: {{request()->route()->getPrefix() == '/Inquiry' ? 'block' : 'none;' }};">
							<li><a href="{{route('Inquiry')}}" class="{{ Route::currentRouteName()=='Inquiry' ? 'active' : '' }}">Advisor Inquiry</a></li>

						</ul>

					</li>
                    <li class="sidebar-list">
						<a class="sidebar-link sidebar-title {{request()->route()->getPrefix() == '/agent-inquiry' ? 'active' : '' }}" href="#"><i data-feather="phone-forwarded"></i><span>{{ trans('Agent Inquiry') }}</span>
							<div class="according-menu"><i class="fa fa-angle-{{request()->route()->getPrefix() == '/agent_inquiry' ? 'down' : 'right' }}"></i></div>
						</a>
                        <ul class="sidebar-submenu" style="display: {{request()->route()->getPrefix() == '/agent-inquiry' ? 'block' : 'none;' }};">
							<li><a href="{{route('agent-inquiry')}}" class="{{ Route::currentRouteName()=='agent-inquiry' ? 'active' : '' }}">Agent Inquiry</a></li>
                      ...
                      <li class="sidebar-list">
						<a class="sidebar-link sidebar-title {{request()->route()->getPrefix() == '/user' ? 'active' : '' }}" href="#">
							<i data-feather="users"></i><span> {{ trans('Agents Management') }} </span>
						...
						<ul class="sidebar-submenu" style="display: {{ request()->route()->getPrefix() == '/user' ? 'block;' : 'none;' }}">
		                    <li><a href="{{route('user')}}" class="{{ Route::currentRouteName()=='user' ? 'active' : '' }}">{{ trans('Agents List') }}</a></li>
		                </ul>
                    ...
                    <li class="sidebar-list">
						<a class="sidebar-link sidebar-title {{request()->route()->getPrefix() == '/advisor-management' ? 'active' : '' }}" href="#">
							<i data-feather="users"></i><span> {{ trans('Advisors Management') }} </span>
							<div class="according-menu"><i class="fa fa-angle-{{request()->route()->getPrefix() == '/advisor-management' ? 'down' : 'right' }}"></i></div>
						</a>

                        <ul class="sidebar-submenu" style="display: {{ request()->route()->getPrefix() == '/advisor-management' ? 'block;' : 'none;' }}">
		                    <li><a href="{{route('advisor-management')}}" class="{{ Route::currentRouteName()=='advisor-management' ? 'active' : '' }}">{{ trans('Advisors List') }}</a></li>
		                </ul>
					</li>
                    ...
                    {{-- <li class="sidebar-list">
						<a class="sidebar-link sidebar-title {{request()->route()->getPrefix() == '/client_management' ? 'active' : '' }}" href="#">
							<i data-feather="users"></i><span> {{ trans('Client Management') }} </span>
							<div class="according-menu"><i class="fa fa-angle-{{request()->route()->getPrefix() == '/client_management' ? 'down' : 'right' }}"></i></div>
						</a>

                        <ul class="sidebar-submenu" style="display: {{ request()->route()->getPrefix() == '/client_management' ? 'block;' : 'none;' }}">
		                    <li><a href="{{route('client_management')}}" class="{{ Route::currentRouteName()=='client_management' ? 'active' : '' }}">{{ trans('Agents Details') }}</a></li>
		                </ul>
					</li> --}}
                 {{-- ==== Subscription Management WORK ===  --}}

                    <li class="sidebar-list">
						<a class="sidebar-link sidebar-title {{request()->route()->getPrefix() == '/Configuration' ? 'active' : '' }}" href="#">
							<i data-feather="plus-square"></i> <span>{{ trans('Configuration') }} </span>
							<div class="according-menu"><i class="fa fa-angle-{{request()->route()->getPrefix() == '/Configuration' ? 'down' : 'right' }}"></i></div>
						</a>
						<ul class="sidebar-submenu" style="display: {{ request()->route()->getPrefix() == '/Configuration' ? 'block;' : 'none;' }}">
		                    <li><a href="{{route('Configuration')}}" class="{{ Route::currentRouteName()=='Configuration' ? 'active' : '' }}">{{ trans('Configuration List') }}</a></li>
		                </ul>
					</li>
