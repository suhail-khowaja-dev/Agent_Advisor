                    ...
                    <div class="card-header">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2 offset-lg-2" align="right">
                                <a class="btn btn-primary createButton" href="{{ route('advisor-create') }}">
                                ...
                                <tbody>
                                    @foreach ($getCMS as $key => $value)
                                        <tr>
                                            ...
                                            <td><a href="{{ route('advisor_status', ['id' => $value->id]) }}">
                                                @if ($value->status == 1)
                                            ...
                                            <td>
                                                <a  href="{{ route('advisor-destroy', $value->slug) }}" id="delete"><button class="btn btn-danger btn-xs round-cstm-btn-red" type="button" data-original-title="btn btn-danger btn-xs" title="">Delete</button></a>
                                                <a href="{{ route('advisor-management-edit', $value->slug) }}"><button class="btn btn-success btn-xs round-cstm-btn-green" type="button" data-original-title="btn btn-danger btn-xs" title=""> Edit</button></a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
