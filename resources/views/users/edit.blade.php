    ...
    <div class="col-sm-12">
        <div class="card">
            ...
            {{-- <form class="form theme-form"> --}}
                <form class="form theme-form" id="regiterForm" action="{{ route("user_update",$edit_data->id ) }}" enctype="multipart/form-data" method="post">
                    @csrf
                    ...
                    {{-- <div class="row">
                        <div class="col">
                            <div class="mb-3">
                                ...
                                <input name="city" class="form-control btn-square"  value="{{ $edit_data->getcity->city }}" id="exampleFormControlInput10" type="text" placeholder="Location">
                            </div>
                        </div>
                    </div> --}}
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="mb-3">
                                ...
                                <input name="phone_no" id="phone12" class="form-control btn-square"  value="{{ $edit_data->phone_no }}" id="exampleFormControlInput10"  type="tel"  pattern="[(][0-9]{3}[)] [0-9]{3}-[0-9]{4}" placeholder="Phone">
                            </div>
                        </div>
                    </div>
                    <div class="row">
