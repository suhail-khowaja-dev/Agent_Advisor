    ...
    <div class="col-sm-12">
        <div class="card">
            ...
            {{-- <form class="form theme-form"> --}}
                <form class="form theme-form" id="regiterForm" action="{{ route("user-store") }}" enctype="multipart/form-data" method="post">
                    @csrf
                ...
                <div class="card-body">
                        ...
                        <div class="col">
                            <div class="mb-3">
                                ...
                                <select name="state" id="state" class="form-select" size="1">
                                    ...
                                    <option  value="{{$item->id}}" class="states">{{$item->state}}</option>
                                    @endforeach
                    ...
                    {{-- <div class="row">
                        <div class="col">
                            <div class="mb-3">
                                <label for="exampleFormControlInput10">Agent/Advisor.*</label>
