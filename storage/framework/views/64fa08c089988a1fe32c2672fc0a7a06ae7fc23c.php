...
<body>
    ...
    <table
        ...
        <tr>
            ...
            <th style="padding-top: 40px;"><img src="<?php echo e($message->embed(asset('frontend/images/1x/passwordIcon.png'))); ?>" alt=""
        ...
        ">
                ...
                <button style="background-color:#fff;text-decoration:none !important; color: #000; font-weight: 600;padding:8px 14px ;"><a style="text-decoration:none !important;" href="<?php echo e(url('reset-password/'.$token)); ?>">Click For Password Reset</a></button>
            </th>
        </tr>
        <tr>
            <th>
...
<?php /**PATH C:\xampp\htdocs\agent_advisor\resources\views/website/forgetemail/reset.blade.php ENDPATH**/ ?>