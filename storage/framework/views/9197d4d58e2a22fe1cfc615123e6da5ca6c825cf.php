    ...
    <table
        ...
        <tr>
            ...
            color:#fff;padding-top: 0px;">
                    Hello !<br><?php echo e($data->get_agent['name'] ?? ''); ?> has Accepted Job Request !</h1>
            </th>
        </tr>
        <tr>
        ...
        <tr>
            <th>
                <p style=" font-family: Poppins-SemiBold;color: #fff;padding-top: 40px;">Agent
                    <?php echo e($data->get_agent['name'] ?? ''); ?> has Accepted Job Request.
                </p>
            </th>
        </tr>
    </table>
...
<?php /**PATH C:\xampp\htdocs\agent_advisor\resources\views/website/declinemail/accept_agent.blade.php ENDPATH**/ ?>