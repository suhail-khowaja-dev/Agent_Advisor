    ...
    <div class="col-sm-12">
        <div class="card">
            <div class="card-header">
                ...
                <form class="form theme-form" id="regiterForm" action="<?php echo e(route("user_update",$edit_data->id )); ?>" enctype="multipart/form-data" method="post">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="mb-3">
                                ...
                                <input name="phone_no" id="phone12" class="form-control btn-square"  value="<?php echo e($edit_data->phone_no); ?>" id="exampleFormControlInput10"  type="tel"  pattern="[(][0-9]{3}[)] [0-9]{3}-[0-9]{4}" placeholder="Phone">
                            </div>
                        </div>
                    </div>
                    <div class="row">
...
<?php echo $__env->make('layouts.simple.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\agent_advisor\resources\views/users/edit.blade.php ENDPATH**/ ?>