    ...
    <div class="col-sm-12">
        <div class="card">
            <div class="card-header">
                ...
                <form class="form theme-form" id="regiterForm" action="<?php echo e(route("user-store")); ?>" enctype="multipart/form-data" method="post">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="mb-3">
                                ...
                                <input name="name" class="form-control btn-square" id="exampleFormControlInput10" value="<?php echo e(old('name')); ?>" type="text" placeholder="Name">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col">
                            <div class="mb-3">
                                ...
                                <input name="email" class="form-control btn-square" id="exampleFormControlInput10" type="text" value="<?php echo e(old('email')); ?>" placeholder="Email">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col">
                            <div class="mb-3">
                                ...
                                <input name="phone_no" class="form-control btn-square" id="phone12" type="tel" value="<?php echo e(old('phone_no')); ?>"  pattern="[(][0-9]{3}[)] [0-9]{3}-[0-9]{4}" placeholder="Phone">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col">
                            <div class="mb-3">
                                ...
                                <select name="state" id="state" class="form-select" size="1">
                                    ...
                                    <option  value="<?php echo e($item->id); ?>" class="states"><?php echo e($item->state); ?></option>
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="mb-3">
                                ...
                                <input name="subject" class="form-control btn-square" id="exampleFormControlInput10" value="<?php echo e(old('subject')); ?>" type="text" placeholder="Subject">
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.simple.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\agent_advisor\resources\views/users/create.blade.php ENDPATH**/ ?>