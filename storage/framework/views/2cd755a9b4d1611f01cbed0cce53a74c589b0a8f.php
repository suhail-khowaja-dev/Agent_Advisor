<?php $__env->startSection('title', 'Advisor'); ?>
<?php $__env->startSection('content'); ?>

    <?php if(Session::has('authenticate')): ?>
        <script type="text/javascript">
            swal("Un Authorize!", "<?php echo e(Session::get('authenticate')); ?>", "warning");
        </script>
    <?php elseif(Session::has('update')): ?>
        <script type="text/javascript">
            swal("Agent Update!", "<?php echo e(Session::get('update')); ?>", "success");
        </script>
    <?php elseif(Session::has('client')): ?>
        <script type="text/javascript">
            swal("Client!", "<?php echo e(Session::get('client')); ?>", "success");
        </script>
    <?php elseif(Session::has('advisorcontact')): ?>
        <script type="text/javascript">
            swal("Message!", "<?php echo e(Session::get('advisorcontact')); ?>", "success");
        </script>
    <?php elseif(Session::has('delete')): ?>
        <script type="text/javascript">
            swal("Message!", "<?php echo e(Session::get('delete')); ?>", "success");
        </script>
        <?php elseif(Session::has('updated')): ?>
        <script type="text/javascript">
            swal("Agent Updated!", "<?php echo e(Session::get('updated')); ?>", "success");
        </script>
    <?php elseif(Session::has('select')): ?>
    <script type="text/javascript">
     swal("Agent Error!", "<?php echo e(Session::get('select')); ?>", "error");
    </script>
    <?php endif; ?>
    <style>
        .ddtable {
                ...
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <div class="myrefClientBox myrefClientBox1">
                            <div class=" myimgesec2">
                                <div class="iimg">
                                    <img src="<?php echo e(asset('frontend/images/1x/refClient.png')); ?>" alt="Image" width="100%"
                                        height="100%">
                                </div>
                            </div>
                            <div class="myreferenceClientText">
                                <h5>
                                    <?php echo e($advisor_client->client_title ?? ''); ?>

                                </h5>
                                <p>
                                    <?php echo $advisor_client->client_description ?? ''; ?>

                                </p>
                                <a href="<?php echo e(route('refer-clients')); ?>" class="d-flex">
                                    <div class="refcA">
                                        Refer Clients
                                    </div>
                                    <div class="imgg">
                    ...
                    <div class="col-lg-6">
                        <div class="myrefClientBox">
                            ...
                            <div class="myreferenceClientText">
                                <h5>
                                    <?php echo e($advisor_client->contact_title ?? ''); ?>

                                </h5>
                                <p>
                                    <?php echo $advisor_client->contact_description ?? ''; ?>

                                </p>
                                <a href="<?php echo e(route('advisor-contact')); ?>" class="d-flex">
                                    <div class="refcA">
                                        Contact Us
                                    </div>
                                    <div class="imgg">
                            ...
                            <table id="table2" class="table">
                                ...
                                <tbody>
                                    ...
                                    <?php endif; ?>
                                        <tr>
                                            <td>
                                                <a href="<?php echo e(route('agent-details', ['slug' => $item->slug])); ?>">
                                            ...
                                            <td>
                                                <?php if($item->status  == 1 || $item->status == null ): ?>
                                                <?php echo e($item->get_agent->name ?? 'N/A'); ?>
                                            ...
                                            <td>
                                                <?php echo e($item->getstate->state ?? ''); ?>, <?php echo e($item->getcity->city ?? ''); ?>

                                            </td>
                                            <?php if($item->get_agent == ''): ?>
                                            <td>
                                                <button
                                                    onclick="reasign_agent(<?php echo e($item->id); ?>,<?php echo e($item->agent_id); ?>)"
                                                    data-bs-toggle="modal" data-bs-target="#exampleModal" value="<?php echo e($item->getcity->id ?? ''); ?>" class="locationreassign">
                                                    Assign
                                                </button>
                                            </td>
                                            ...
                                            <td>
                                                <button
                                                    onclick="reasign_agent(<?php echo e($item->id); ?>,<?php echo e($item->agent_id); ?>)"
                                                    data-bs-toggle="modal"  value="<?php echo e($item->getcity->id ?? ''); ?>" class="locationreassign">
                                                   Assigned
                                                </button>
                                            </td>
                                            <?php endif; ?>
                                            <td>
                                                <div class="editdlt d-flex">
                                                    <div class="icon1">
                                                        <a href="<?php echo e(route('advisor-edit', $item->slug)); ?>">
                                                            <img src="<?php echo e(asset('frontend/images/1x/editIcon.png')); ?>"
                                                                alt="" width="100%" height="100%">
                                                        </a>
                                                    </div>
                                                    <div class="icon2">
                                                        <a href="<?php echo e(route('agent_delete', $item->id)); ?>">
                                                            <img src="<?php echo e(asset('frontend/images/1x/dltIcon.png')); ?>"
                                                                alt="" width="100%" height="100%">
                                                        </a>
                                                    </div>
                                                </div>
                                        ...
                                        <tbody>
                                            <?php $__currentLoopData = $approved; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php echo e($item->get_agent->name ?? ''); ?>


                                                    </td>

                                                    <td>
                                                        <?php echo e($item->getstate->state ?? ''); ?>,
                                                        <?php echo e($item->getcity->city ?? ''); ?>
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <form action="<?php echo e(route('agent_reasign')); ?>" method="POST" id="regiterForm">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('website.master.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\agent_advisor\resources\views/website/advisor.blade.php ENDPATH**/ ?>