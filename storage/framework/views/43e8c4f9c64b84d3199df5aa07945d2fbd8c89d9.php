    ...
    <table
        ...
        <tr>
            ...
            color:#fff;padding-top: 0px;text-transform: capitalize;">
                    Hello <?php echo e($data['name']); ?> !<br>Your registration is approved !</h1>
            </th>
        </tr>
        <tr>
        ...
        ">
                ...
                <p style="text-decoration:none;">Password:<?php echo e($data['password']); ?></p>
            </th>
        </tr>
...
<?php /**PATH C:\xampp\htdocs\agent_advisor\resources\views/website/advisormail/credentials.blade.php ENDPATH**/ ?>