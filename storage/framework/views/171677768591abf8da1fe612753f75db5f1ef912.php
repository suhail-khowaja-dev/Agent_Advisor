    ...
    <div class="col-sm-12">
        <div class="card">
            <div class="card-header">
                ...
                <form class="form theme-form" id="regiterForm" action="<?php echo e(route("advisor-store")); ?>" enctype="multipart/form-data" method="post">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.simple.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\agent_advisor\resources\views/advisor/create.blade.php ENDPATH**/ ?>