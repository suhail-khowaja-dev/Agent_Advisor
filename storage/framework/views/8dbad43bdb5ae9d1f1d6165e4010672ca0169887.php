    ...
    <table
        ...
        <tr>
            ...
            color:#fff;padding-top: 0px;text-transform: capitalize;">
                    Hello !<br> New User Registered Successfully Please Check !</h1>
            </th>
        </tr>
        <tr>

            <th style="padding-top: 20px;"><img src="<?php echo e($message->embed(asset('frontend/images/1x/thumbs-u.png'))); ?>" alt=""
                    style="width:20%;border-radius: 20%;height: 100%;object-fit: cover;"></th>
        </tr>
        <tr>

            <th style="letter-spacing: 4px;
        color:#fff;padding-top: 40px;text-transform: capitalize;width: 40%;
        ">
                <p style="text-decoration:none;">Name:<?php echo e($data['name']); ?></p>
                ...
                <p style="text-decoration:none;">Phone:<?php echo e($data['phone_no']); ?></p>
            </th>
        </tr>

        <tr>
            <th>
                <p style=" font-family: Poppins-SemiBold;color: #fff;padding-top: 40px;">New User Registered Successfully .
                </p>
            </th>
        </tr>
    </table>
...
<?php /**PATH C:\xampp\htdocs\agent_advisor\resources\views/website/agentmail/new_user.blade.php ENDPATH**/ ?>